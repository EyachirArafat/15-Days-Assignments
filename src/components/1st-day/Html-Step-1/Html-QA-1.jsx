...
import { BasicStructure } from "../data";
  ...
  return (
    <Container>
      ...
      <p>
        ...
        <span className="text-secondary">এর আবিষ্কারক হলেন টিম বার্নার্স-লি (Tim Berners-Lee)</span>।<br />
      ...
      <p className="text-secondary">স্ট্রাকচার, কন্টেন্ট প্রেজেন্টেশন, ইন্টারঅ্যাকশন</p><br /><br />
